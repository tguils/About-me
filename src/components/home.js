...
export default function Home() {
    return (
        <div className='container-sm d-flex align-items-center justify-content-center position-relative' style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.25)', height: '700px' }}>
